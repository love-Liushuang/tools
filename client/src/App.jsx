...
function shouldCheckAdBlock(pathname) {
  ...
  return normalizedPath.startsWith('/tools/') && normalizedPath !== '/tools/changelog';
}

function AdBlockRouteGate({ children }) {
  const location = useLocation();

  return (
    <AdBlockNotice enabled={shouldCheckAdBlock(location.pathname)}>
      {children}
    </AdBlockNotice>
  );
}
